...
public class CalculatorBaseView
{
    ...
    public void SelectCalculatorType(CalculatorType type)
    {
        ToggleButton.Click();
        switch(type)
        {
            case CalculatorType.Scientific: ScientificType.Click(); break;
            case CalculatorType.Temperature: TemperatureType.Click(); break;
            case CalculatorType.Area:
                _driver.Keyboard.PressKey(Keys.PageDown);
                AreaType.Click(); break;
            case CalculatorType.Standard: StandardType.Click(); break;
        }
    }
